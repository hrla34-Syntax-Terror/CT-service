...
import SmallCheckMark from './SmallCheckMark.jsx';
...
class AskAQuestion extends React.Component {
  ...
  postQuestion() {
    const {formCompleted, qNickname, question, qDate, qEmail, qLocation} = this.state;
    const {hideAskAQuestion, questionSubmit, QApairs} = this.props;
    this.setState({
      postQClicked: true,
    });
    if (formCompleted) {
  ...
  render() {
    ...
    return (
      <div className="ct-ask-q-main">
        <div className="ct-ask-q-header">
          <h2 className="ct-q-and-a" id="ct-ask-q-title">Ask a Question</h2> 
          <a href="#ct-qa-container"><div className="ct-close-container">
            <div className="ct-close-ask-q" onClick={() => this.props.hideAskAQuestion()}></div>
          </div></a>
        </div>
        ...
        <div className="ct-form">
          <div className="ct-form-askq-q">
            <div className="ct-ask-q-container">
              <span id="ct-q-title" style={{fontWeight: 'bold'}}>Question*
